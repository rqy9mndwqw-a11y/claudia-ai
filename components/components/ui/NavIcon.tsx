...
/**
 * Inline SVG icons for sidebar navigation.
 * No icon library — keeps bundle tiny.
 * Each icon is 20x20, stroke-based for consistency.
 */
...
const icons: Record<string, React.ReactNode> = {
  ...
  candlestick: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="13" y="4" width="4" height="8" rx="1" />
    </svg>
  ),
  layers: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
