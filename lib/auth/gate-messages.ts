export const GATE_MESSAGES = {
  NOT_CONNECTED: {
    ...
    body: "Connect your wallet or sign in with email to get 10 free credits.",
    cta: "Connect Wallet",
    ctaSecondary: "Sign in with Email",
  },
  NO_CLAUDIA: {
    title: "Hold $CLAUDIA to unlock",
    body: "You've used your 10 free credits. Buy $CLAUDIA on Aerodrome to continue.",
  ...
  FREE_CREDITS: {
    title: "10 free credits — 24h only",
    body: "You have {n} free credits remaining. Buy $CLAUDIA to keep access.",
    cta: "Use free credits",
