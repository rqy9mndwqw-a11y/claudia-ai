...
export const AGENT_NAME_TO_ID: Record<string, string> = {
  ...
  "bot analyst": "claudia-bot-performance",
  "bot performance": "claudia-bot-performance",
  "trading bot": "claudia-bot-performance",
};
...
export const AGENT_ID_TO_INFO: Record<string, { name: string; icon: string; description: string }> = {
  ...
  "claudia-bot-performance": { name: "Bot Analyst", icon: "🤖", description: "Real bot performance — win rates, P&L, strategy accuracy" },
};
